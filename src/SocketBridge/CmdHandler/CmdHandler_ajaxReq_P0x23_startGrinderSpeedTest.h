...
namespace socketbridge
{
     ...
     *
		...
		Alla ricezione del comando, CPUBridge risponde OK ed entra nello stato [eVMCState_GRINDER_SPEED_TEST] (106) e inzia a macinare per il tempo [d] usando la macina [m].
