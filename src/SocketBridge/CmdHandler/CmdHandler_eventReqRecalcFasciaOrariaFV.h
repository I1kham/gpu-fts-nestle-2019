#ifndef _CmdHandler_eventReqRecalcFasciaOrariaFV_h_
#define _CmdHandler_eventReqRecalcFasciaOrariaFV_h_
...
{
    /*********************************************************
     * CmdHandler_eventReqRecalcFasciaOrariaFV
     *
     *
     *
     */
    class CmdHandler_eventReqRecalcFasciaOrariaFV : public CmdHandler_eventReq
    {
    public:
		...
		static const u16		EVENT_ID_FROM_CPUBRIDGE = CPUBRIDGE_NOTIFY_MAX_ALLOWED;		//vuol dire che questa classe non risponde ad alcuna notifica di CPUBridge
                    ...
                    CmdHandler_eventReqRecalcFasciaOrariaFV (const HSokBridgeClient &identifiedClientHandle, u16 handlerID, u64 dieAfterHowManyMSec) :
...
#endif // _CmdHandler_eventReqRecalcFasciaOrariaFV_h_
