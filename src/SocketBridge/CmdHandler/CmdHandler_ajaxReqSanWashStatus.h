#ifndef _CmdHandler_ajaxReqSanWashStatus_h_
#define _CmdHandler_ajaxReqSanWashStatus_h_
...
{
    /*********************************************************
     * CmdHandler_ajaxReqSanWashStatus
     *
    ...
    class CmdHandler_ajaxReqSanWashStatus : public CmdHandler_ajaxReq
    {
    public:
		CmdHandler_ajaxReqSanWashStatus(const HSokBridgeClient &identifiedClientHandle, u16 handlerID, u64 dieAfterHowManyMSec, u8 ajaxRequestID) :
