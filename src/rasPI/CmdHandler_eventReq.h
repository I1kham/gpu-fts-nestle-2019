...
namespace socketbridge
{
    ...
    public:
        ...
        virtual void            fwdRequestToGPU (const u8 *payload, u16 payloadLen) = 0;

        virtual void			handleRequestCore(rasPI::socketListener::Core *core UNUSED_PARAM, HSokServerClient &hClient UNUSED_PARAM)
								{ 
