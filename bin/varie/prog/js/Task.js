...
TaskGrinderClean.prototype.priv_show = function (text, text_btn1, text_btn2)
{
	...
	{
		pleaseWait_freeText_setText ("<b>$LAB_PAGE_GRINDER_CLEANING_TITLE</b><br><br>" + text);
		pleaseWait_freeText_show();
	}
}
...
TaskGrinderClean.prototype.step2 = function()
{
	...
	this.priv_show ("Close bean hopper shutter to avoid loss of beans.<br>Press CONTINUE when done.", "$LAB_CONTINUE", "");
}

TaskGrinderClean.prototype.step3 = function()
{
	this.fase = 3;
	this.priv_show ("Remove brewer and bean hopper.<br>Press CONTINUE when done.", "$LAB_CONTINUE", "");
}
...
TaskGrinderClean.prototype.step5 = function()
{
	this.fase = 5;
	pleaseWait_rotella_hide();
	this.priv_show ("Install grinder cleaning device.<br>Press CONTINUE when done.", "$LAB_CONTINUE", "");	
}

TaskGrinderClean.prototype.step6 = function()
{
	this.fase = 6;
	this.priv_show ("Refill cleaning device.<br>When done, press CONTINUE.<br><br><b>WARNING:</b> as soon as you press CONTINUE, the grinder will start running", "$LAB_CONTINUE", "");	
}
...
TaskGrinderClean.prototype.step20 = function()
{
	this.fase = 20;
	pleaseWait_rotella_hide();
	this.priv_show ("Do you want to repeat the cleaning procedure?", "$LAB_NO", "$LAB_YES");
}

TaskGrinderClean.prototype.step21 = function()
{
	this.fase = 21;
	this.priv_show ("Put back  bean hopper. Press CONTINUE when done.", "$LAB_CONTINUE", "");
}

TaskGrinderClean.prototype.step23 = function()
{
	this.fase = 23;
	this.priv_show ("Open hopper shutter. When done, press CONTINUE.<br><br><b>WARNING:</b> as soon as you press CONTINUE, the grinder will start running.", "$LAB_CONTINUE", "");	
}
...
{
	this.fase = 26;
	this.priv_show ("Put brewer back into position, press CONTINUE when done.", "$LAB_CONTINUE", "");
}
...
TaskGrinderClean.prototype.step28 = function()
{
	this.fase = 28;
	pleaseWait_rotella_hide();
	this.priv_show ("Do you want do dispense a coffe?<br><br><b>N.B.:</b> for DEMO purpose, whatever is in selection 1 will be used for coffee delivery.", "$LAB_NO", "$LAB_YES");
}
