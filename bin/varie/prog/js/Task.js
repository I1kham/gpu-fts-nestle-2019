	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			switch (me.fase)
			{
				...
				case 28: pleaseWait_freeText_setText("$LAB_CLEANSAN_VFLEX_SKIP_COFFEE"); break; //Do you want to skip the final coffee ?
				case 29: pleaseWait_freeText_setText("$LAB_CLEANSAN_VFLEX_COFFEE_DELIVER"); break; //Coffee delivery, please wait

				case 30: pleaseWait_freeText_setText("$LAB_CLEANSAN_VFLEX_20"); break; //Brewer Rinsing 
				case 31: pleaseWait_freeText_setText("$LAB_CLEANSAN_VFLEX_21"); break; //Mixer 1 Rinsing
				case 32: pleaseWait_freeText_setText("$LAB_CLEANSAN_VFLEX_22"); break; //Mixer 2 Rinsing
				case 33: pleaseWait_freeText_setText("$LAB_CLEANSAN_VFLEX_23"); break; //Mixer 3 Rinsing 
				case 34: pleaseWait_freeText_setText("$LAB_CLEANSAN_VFLEX_24"); break; //Brewer Cleaning Done. Press CLOSE to exit
		...
		.then( function(result) 
		{
			...
			else
			{
				...
				case 3:	//CIC_WAIT_FOR_TABLET_DISSOLVING
					pleaseWait_freeText_setText("$LAB_MILKER2_CLEAN_2"); //Wait for tablet dissolving
					break;
...
TaskGrinderClean.prototype.onEvent_cpuStatus  	= function(statusID, statusStr, flag16)		{ this.cpuStatus = statusID; pleaseWait_header_setTextL ("$LAB_PAGE_GRINDER_CLEANING_TITLE"); }
...
TaskGrinderClean.prototype.runGrinderCycle_1 = function()
{
	this.fase = 201;
console.log ("fase: "+this.fase)	
	pleaseWait_freeText_setText ("<b>$LAB_PAGE_GRINDER_CLEANING_TITLE</b><br><br>Running grinder cycle " +this.curCiclo +" of " +this.numCicli);
	pleaseWait_freeText_show();
...
console.log ("fase: "+this.fase)	
	...
	pleaseWait_freeText_setText ("<b>$LAB_PAGE_GRINDER_CLEANING_TITLE</b><br><br>Running grinder cycle " +(this.curCiclo-1) +" of " +this.numCicli +"<br>Waiting " +timeLeftSec +" sec.");
	pleaseWait_freeText_show();
...
TaskGrinderClean.prototype.step1 = function()
{
	...
	var html = 	"<b>$LAB_PAGE_GRINDER_CLEANING_TITLE</b><br><br>";
...
TaskGrinderClean.prototype.step2 = function()
{
	...
	pleaseWait_freeText_setText ("<b>$LAB_PAGE_GRINDER_CLEANING_TITLE</b><br><br>Close bean hopper shutter to avoid loss of beans.<br>Press CONTINUE when done.");
...
{
	this.fase = 3;
	pleaseWait_freeText_setText ("<b>$LAB_PAGE_GRINDER_CLEANING_TITLE</b><br><br>Remove brewer and bean hopper.<br>Press CONTINUE when done.");
	pleaseWait_freeText_show();
...
TaskGrinderClean.prototype.step5 = function()
{
	this.fase = 5;
	pleaseWait_rotella_hide();
	pleaseWait_freeText_setText ("<b>$LAB_PAGE_GRINDER_CLEANING_TITLE</b><br><br>Install grinder cleaning device.<br>Press CONTINUE when done.");
	pleaseWait_freeText_show();
...
TaskGrinderClean.prototype.step6 = function()
{
	this.fase = 6;
console.log ("fase: "+this.fase)	
	pleaseWait_freeText_setText ("<b>$LAB_PAGE_GRINDER_CLEANING_TITLE</b><br><br>Refill cleaning device.<br>When done, press CONTINUE.<br><br><b>WARNING:</b> as soon as you press CONTINUE, the grinder will start running");
	pleaseWait_freeText_show();
...
console.log ("fase: "+this.fase)	
	pleaseWait_freeText_hide();
	pleaseWait_freeText_setText ("<b>$LAB_PAGE_GRINDER_CLEANING_TITLE</b><br><br>Do you want to repeat the cleaning procedure?");
	pleaseWait_freeText_show();

	pleaseWait_btn1_setText("$LAB_NO");
	pleaseWait_btn1_show();

	pleaseWait_btn2_setText("$LAB_YES");
	pleaseWait_btn2_show();
}
...
TaskGrinderClean.prototype.step21 = function()
{
	this.fase = 21;
console.log ("fase: "+this.fase)	
	pleaseWait_freeText_setText ("<b>$LAB_PAGE_GRINDER_CLEANING_TITLE</b><br><br>Put back  bean hopper. Press CONTINUE when done.");
	pleaseWait_freeText_show();
...
TaskGrinderClean.prototype.step23 = function()
{
	this.fase = 23;
console.log ("fase: "+this.fase)	
	pleaseWait_freeText_setText ("<b>$LAB_PAGE_GRINDER_CLEANING_TITLE</b><br><br>Open hopper shutter. When done, press CONTINUE.<br><br><b>WARNING:</b> as soon as you press CONTINUE, the grinder will start running");
	pleaseWait_freeText_show();
...
console.log ("fase: "+this.fase)
	pleaseWait_freeText_hide();
	pleaseWait_freeText_setText ("<b>$LAB_PAGE_GRINDER_CLEANING_TITLE</b><br><br>Put brewer back into position, press CONTINUE when done");
	pleaseWait_freeText_show();
...
TaskGrinderClean.prototype.step28 = function()
{
	this.fase = 28;
console.log ("fase: "+this.fase)
	pleaseWait_freeText_setText ("<b>$LAB_PAGE_GRINDER_CLEANING_TITLE</b><br><br>Do you want do dispense a coffe?<br><br><b>N.B.:</b> for DEMO purpose, whatever is in selection 1 will be used for coffee delivery.");
	pleaseWait_freeText_show();
