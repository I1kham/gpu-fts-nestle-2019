...
UINumber.prototype.priv_buildHTML = function(nodeIN)
{
	...
	for (var i=0; i<this.numCifre; i++)
	{
		...
		if (this.numDecimalAfterPoint>0 && i == this.numCifre - this.numDecimalAfterPoint -1)
			html += "<div class='UINumber2Container' style='width:15px; font-size:3.0em;'>.</div>";
	}
	...
	if (um != "")
	{
		...
		html += "<div id='" +idUM +"' class='UINumber2Container' style='width:auto; height:auto; font-size:1.0em;'>" +um +"</div>";
	}
...
UINumber.prototype.priv_getHTMLForAFigure = function(i)
{
	...
	var html =   "<div class='UINumber2Container' id='" +idContainer +"'>"
				+"	<div class='UINumber2Inner'>"
				+"		<div class='UINumber2Strip' id='" +idStrip +"'>"
				+"			<p>0</p><p>1</p><p>2</p><p>3</p><p>4</p><p>5</p><p>6</p><p>7</p><p>8</p><p>9</p>"
				+"		</div>"
				+"		<div class='UINumber2Mask'>&nbsp;</div>"				
				+"	</div>"
				
				+"	<div class='UINumber2Border'>&nbsp;</div>"
				+"	<div style='position:absolute; top:-1px; left:17px; z-index:22;'><img src='img/UINumberArrowUp-grey.png' draggable='false'></div>"
				+"	<div style='position:absolute; top:82px; left:17px; z-index:22;'><img src='img/UINumberArrowDown-grey.png' draggable='false'></div>"
				+"	<div id='" +idClicker +"' class='UINumber2Clicker'>&nbsp;</div>"
				+"</div>";
	return html;
}
