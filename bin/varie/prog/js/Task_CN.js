		...
		.then( function(result) 
		{
			...
			else
			{
				...
				case 7: //CIC_WAIT_FOR_MILK_TUBE
					pleaseWait_freeText_setText("清洁程序已完成。<br><br>请记住：<ul><li>清空废水箱</li><li>将牛奶管放回原位</li></ul><br>按“关闭”关闭此窗口"); //The cleaning procedure is finished.<br><br>Please, remember to:<ul><li>empty Waste tank</li><li>put the milk pipe back into position</li></ol><br>Press CLOSE to close this window
					break;
...
TaskDisintall.prototype.onTimer = function (timeNowMsec)
{
	...
	case 40:
		if (bBollitore400cc)
			pleaseWait_freeText_setText("卸载完成，请“关闭”锅炉水龙头并“关闭”机器"); //DISINTALLATION finished, please shut down the machine
		else
