	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			else
			{
				...
				case 7:		pleaseWait_btn1_setText ("FERME"); break;
				}
				pleaseWait_btn1_show();	
			}
