	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			else
			{
				...
				else
				{
					...
					switch (me.fase)
					{
						...
						case 10: btnText = "SALTA CAFFE'"; break;
					}
			...
			else
			{
				...
				switch (me.fase)
				{
					case 10: btnText = "FAI UN CAFFE'"; break;
				}
...
TaskCleaning.prototype.priv_handleMilkWashing = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				pleaseWait_btn1_setText ("BOTTONE " +me.btn1);
				pleaseWait_btn1_show();	
			}
...
TaskCalibMotor.prototype.priv_handleCalibProdotto = function (timeElapsedMSec)
{
	...
	case 20:
		me.fase = 30;
		pleaseWait_calibration_setText("Inputare la quantità poi premere CONTINUA"); //Please enter the quantity, then press CONTINUE
