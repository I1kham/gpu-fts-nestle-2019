...
const 	RHEA_DEFAULT_FALLOFF_LANGUAGE = "GB";

//costanti di comodo da passare come parametro alla fn requestGPUEvent()
const 	RHEA_EVENT_SELECTION_AVAILABILITY_UPDATED = 97;
const	RHEA_EVENT_SELECTION_PRICES_UPDATED = 98;
const	RHEA_EVENT_CREDIT_UPDATED = 99;
 ...
 */
Rhea.prototype.sendGPUCommand = function (commandChar, bufferArrayIN, bReturnAPromise)
{
	var requestID = 255;
	var iReq;
...
Rhea.prototype.ajax = function(commandString, plainJSObject)
{
	...
	return this.sendGPUCommand ("A", buffer, 1);
};
...
Rhea.prototype.requestGPUEvent = function (eventTypeID)
{
	...
	buffer[0] = eventTypeID;
		this.sendGPUCommand ("E", buffer, 0);
}
