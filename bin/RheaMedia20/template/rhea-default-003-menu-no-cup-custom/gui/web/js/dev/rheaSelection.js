...
Rhea.prototype.menuSelection_createEmpty = function(menuSelNumber)
{
	var s = {
		menuGenNum: 		menuSelNumber,
	};
	return s;
}
...
/*********************************************************
 * menuSelection_getCount
 *
 *	ritorna il numero di menu massimi utilizzabili
 */
Rhea.prototype.menuSelection_getCount = function()
{
	return RHEA_NUM_MAX_SELECTIONS_MENU;
}
/*********************************************************
...
/*********************************************************
 * mainSelection_getBySelNumber
 *
 *	[menuGenNum]	=> da 1 a RHEA_NUM_MAX_SELECTIONS_MENU
 */
Rhea.prototype.menuSelection_getBySelNumber = function (menuGenNum)
{
	if (menuGenNum < 1 || menuGenNum > RHEA_NUM_MAX_SELECTIONS_MENU)
	{
		rheaLog ("ERR:Rhea.menuSelection_getBySelNumber(" +menuGenNum +") => invalid menu sel number");
		return this.menuSelection_createEmpty(0);
	}
	
	return this.menuSelectionList[menuGenNum-1];
}
...
Rhea.prototype.menuSelection_sessionRestore = function()
{
	rheaLog ("Rhea.menuSelection_sessionRestore()");
	this.menuSelectionList = [];
	for (var i=1; i<=RHEA_NUM_MAX_SELECTIONS_MENU; i++)
	{
		var s = Rhea_session_getObject("menuSelInfo" +i);
		if (s === undefined)
		{
			s = this.menuSelection_createEmpty(i);
			Rhea_session_setObject("menuSelInfo" +i, s);
		}
		this.menuSelectionList.push (s);
	}	
}
/*********************************************************
...
Rhea.prototype.menuSelection_sessionStore = function()
{
	rheaLog ("Rhea.menuSelection_sessionStore()");
	for (var i=1; i<=RHEA_NUM_MAX_SELECTIONS_MENU; i++)
	{
		Rhea_session_setObject("menuSelInfo" +i, this.menuSelectionList[i-1]);
	}
}
/*********************************************************
 * selection_start
