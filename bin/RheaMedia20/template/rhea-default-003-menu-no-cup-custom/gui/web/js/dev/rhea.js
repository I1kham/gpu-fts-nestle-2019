...
var		RHEA_NUM_MAX_SELECTIONS_MENU = 4;
...
Rhea_clearSessionData = function (defaultLanguage)
{
	...
	//selection session clear
	for (var i=1; i<=RHEA_NUM_MAX_SELECTIONS_MENU; i++)
		Rhea_session_clearObject("menuSelInfo" +i);	
}
...
function Rhea()
{
	...
	this.menuSelection_sessionRestore();
		...
		if (data.length >= 5)
		{
			if (data[0] == 35 && data[1] == 101 && data[2] == 86 && data[3] == 110)
			{
				...
				case RHEA_EVENT_CPU_STATUS:
					...
					{
						Rhea_session_setValue("isFreevend", "1");
						me.isFreevend = 1; 
					}
					...
					{
						Rhea_session_setValue("isTestvend", "1");
						me.isTestvend = 1; 
					}
